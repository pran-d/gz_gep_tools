...
class gz::sim::systems::ContactPrivate
{
  ...
  /// \brief Create sensors that correspond to entities in the simulation
  /// \param[in] _ecm Mutable reference to ECM.
  public: void CheckSensors(EntityComponentManager &_ecm);
  ...
  public: std::unordered_map<Entity,
      std::unique_ptr<ContactSensorTest>> entitySensorMap;
};

//////////////////////////////////////////////////
void ContactSensorTest::Load(const sdf::ElementPtr &_sdf, const std::string &_topic,
                         const std::vector<Entity> &_collisionEntities)
{
...
//////////////////////////////////////////////////
void ContactSensorTest::AddContacts(
    const std::chrono::steady_clock::duration &_stamp,
    const msgs::Contacts &_contacts)
{
  gzmsg << "AddContacts " << this->topic << std::endl;
...
//////////////////////////////////////////////////
void ContactSensorTest::Publish()
{
...
void ContactPrivate::CheckSensors(EntityComponentManager &_ecm)
{
  ...
  _ecm.Each<components::ContactSensor>(
          ...
          const components::ContactSensor *_contact) -> bool
      {
        ...
        auto sensor = std::make_unique<ContactSensorTest>();
  ...
  _ecm.EachRemoved<components::ContactSensor>(
    [&](const Entity &_entity,
        const components::ContactSensor *)->bool
      {
        ...
        gzmsg << "Remove sensor " << std::get<0>(*sensorId)
              << std::endl;
...
//////////////////////////////////////////////////
ContactTest::ContactTest() : System(), dataPtr(std::make_unique<ContactPrivate>())
{
}

//////////////////////////////////////////////////
void ContactTest::PreUpdate(const UpdateInfo &, EntityComponentManager &_ecm)
{
...
//////////////////////////////////////////////////
void ContactTest::PostUpdate(const UpdateInfo &_info,
                             const EntityComponentManager &_ecm)
{
  /*   gzmsg << "PostUpdate "
        << "_info.paused: " << _info.paused
        << " eSM:"
...
void ContactTest::Configure(const Entity &_entity,
    const std::shared_ptr<const sdf::Element> &_sdf,
    EntityComponentManager &_ecm,
    EventManager &/*_eventMgr*/)
{
  gzmsg << "ContactTest::Configure: " <<  std::endl;

  this->dataPtr->CheckSensors(_ecm);
}
//////////////////////////////////////////////////
// void ContactTest::Reset(const UpdateInfo &_info,
//                         EntityComponentManager &_ecm)
// {
//   gzmsg << "ContactTest::Reset" << std::endl;
// }

GZ_ADD_PLUGIN(ContactTest, System,
              ContactTest::ISystemConfigure,
              ContactTest::ISystemPreUpdate,
              ContactTest::ISystemPostUpdate
              //              ,ContactTest::ISystemReset
)

GZ_ADD_PLUGIN_ALIAS(ContactTest, "gz::sim::systems::ContactTest")
